...
description: Hotel search and pricing via RollingGo. Use when the user wants to search hotels by destination, filter by date/star/budget/tags/distance, inspect hotel detail and room pricing, or look up hotel tags. Trigger phrases — "search hotels", "find hotels near", "hotel detail", "hotel pricing", "hotel tags", "rollinggo".
...
- stderr → errors only
- Exit `0` success · `1` HTTP/network failure · `2` validation failure
