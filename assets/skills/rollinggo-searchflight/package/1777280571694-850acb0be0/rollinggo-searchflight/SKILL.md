...
Current public online MCP configuration does **not** require a client-side Bearer Token.

If a private deployment or business channel requires an API key, follow the actual environment configuration. API key applications may be directed to: https://rollinggo.store/apply
